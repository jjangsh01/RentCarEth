        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-8 animate-fade-in-up">
                    ...
                    <h1 className="text-4xl font-black text-white mb-2 bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent">AutoRent</h1>
                    <p className="text-lg text-purple-200 font-medium">스마트 계약 기반 차량 대여 플랫폼</p>
                </div>
            ...
            {showWalletModal && <WalletLoginModal onClose={() => setShowWalletModal(false)} />}
